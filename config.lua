...
M.highlights_base = function (colors)
  return {
    ...
    Cursor = { guifg = colors.foreground, guibg = colors.cursor },
    ...
    Search = { guifg = colors.foreground, guibg = colors.color1 },
    IncSearch = { guifg = colors.foreground, guibg = colors.color1 },
    Substitute = { guifg = colors.color1, guibg = colors.color6 },
    MoreMsg = { guifg = colors.color5 },
    Question = { guifg = colors.color5 },
    EndOfBuffer = { guifg = colors.background },
    NonText = { guifg = colors.color1 },
    Variable = { guifg = colors.color2 },
    String = { guifg = colors.color12 },
    Character = { guifg = colors.color12 },
    Constant = { guifg = colors.color5 },
    Number = { guifg = colors.color5, guibg = colors.background },
    Boolean = { guifg = colors.color5 },
    Float = { guifg = colors.color5 },
    Identifier = { guifg = colors.foreground },
   ...
   -- Neogit
    ...
    -- BufferLine
    BufferLineIndicatorSelected = { guifg = colors.color5 },
    BufferLineFill = { guibg = colors.background },
  }
end
